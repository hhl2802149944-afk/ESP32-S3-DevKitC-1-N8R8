...
// =================配置建议=================
#define WIFI_SSID      "YOUR_WIFI_SSID"      // 修改为你的热点名称
#define WIFI_PASS      "YOUR_WIFI_PASSWORD"  // 修改为你的热点密码
#define RGB_LED_GPIO   38                    // N8R8 建议用 38，避免 48 的 PSRAM 冲突
// ==========================================
...
const char* index_html = "<!DOCTYPE html><html><head><meta charset=\"UTF-8\">"
    ...
    "<p>点击下方选择颜色控制板载灯：</p>"
    "<input type=\"color\" id=\"picker\" onchange=\"updateColor()\" value=\"#ff0000\">"
    "</div><script>"
