...
// 电机 2 引脚 (使用 S3 上物理位置最靠近且相对隔离的 IO 组)
// 避开 11, 12, 13 (Flash) 和 15-18 (FSPI), 33-40 (Octal)
#define MOTOR2_AIN1     1
#define MOTOR2_AIN2     2
#define MOTOR2_PWMA     3
#define MOTOR2_BIN1     14
#define MOTOR2_BIN2     43
#define MOTOR2_PWMB     44
#define MOTOR2_STBY     17
...
// ================= Web Server 已迁移到 web_server.cpp =================
