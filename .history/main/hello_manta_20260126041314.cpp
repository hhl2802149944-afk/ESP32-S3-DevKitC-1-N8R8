...
// 电机 1 (左路 IBT_2)
#define M1_RPWM_PIN     4
#define M1_LPWM_PIN     5

// 电机 2 (右路 IBT_2)
#define M2_RPWM_PIN     6
#define M2_LPWM_PIN     7

// 传感器引脚
#define I2C_SDA_PIN     15
#define I2C_SCL_PIN     16
#define GPS_TX_PIN      17  // ESP32 TX -> GPS RX
#define GPS_RX_PIN      18  // GPS TX -> ESP32 RX

static const char *TAG = "MANTA_CORE";
led_strip_handle_t led_strip;

// 电机状态与速度 (从 shared_state 获取)
MotorState motor1_state = M_STOP;
MotorState motor2_state = M_STOP;
int motor_step_delay = 50; // 在 PWM 模式下映射为速度百分比 (来自网页/APP控制)
...
extern "C" void app_main(void) {
    ...
    ESP_LOGI(TAG, "Manta 24V PWM System Ready.");
}
